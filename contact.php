    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#formModal" onclick="$('#formModal').modal({'backdrop': 'static'});" data-whatever="">Send us a message</button>
